...
process.load('Configuration.Geometry.GeometryExtendedRun4D122_cff')
...
from L1Trigger.L1THGCal.customTriggerGeometry import custom_geometry_V19_Imp1
process = custom_geometry_V19_Imp1(process)
