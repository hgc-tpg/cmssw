...
std::vector<std::pair<l1thgcfirmware::HGCalTriggerCell,int>> HGCalLayer1PhiOrderFwImpl::assignTCToCol(const l1thgcfirmware::HGCalLayer1PhiOrderFwConfig& theConf, std::vector<l1thgcfirmware::HGCalTriggerCell> tcs) const {
...
std::vector<std::pair<l1thgcfirmware::HGCalTriggerCell,int>> HGCalLayer1PhiOrderFwImpl::assignTCToChnAndFrame(const l1thgcfirmware::HGCalLayer1PhiOrderFwConfig& theConf, std::vector<std::pair<l1thgcfirmware::HGCalTriggerCell,int>> ord_tcs) const {
  ...
  std::unordered_map<int, unsigned> chnAndFrameCounterForCol;//This will track the index 'per column', index is index in a vector of tuples;
  for (auto & tc: ord_tcs){
...
int HGCalLayer1PhiOrderFwImpl::packColChnFrame(int column, unsigned channel, unsigned frame) const {//temporary very dumb 3 int -> 1 int conversion, can make this much smarter
  int packed_bin = 0;
