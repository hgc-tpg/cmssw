...
HGCalTriggerGeometryV9::HGCalTriggerGeometryV9(const edm::ParameterSet& conf)
...
void HGCalTriggerGeometryV9::reset() {
...
unsigned HGCalTriggerGeometryV9::getTriggerCellFromCell(const unsigned cell_id) const {
...
unsigned HGCalTriggerGeometryV9::getModuleFromCell(const unsigned cell_id) const {
  return getModuleFromTriggerCell(getTriggerCellFromCell(cell_id));
}

unsigned HGCalTriggerGeometryV9::getModuleFromTriggerCell(const unsigned trigger_cell_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV9::getCellsFromTriggerCell(
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV9::getCellsFromModule(const unsigned module_id) const {
  geom_set cell_det_ids;
...
HGCalTriggerGeometryBase::geom_ordered_set HGCalTriggerGeometryV9::getOrderedCellsFromModule(
...
HGCalTriggerGeometryBase::geom_ordered_set HGCalTriggerGeometryV9::getOrderedTriggerCellsFromModule(
    const unsigned module_id) const {
  HGCalTriggerModuleDetId hgc_module_id(module_id);
  unsigned subdet = hgc_module_id.triggerSubdetId();
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV9::getNeighborsFromTriggerCell(
    const unsigned trigger_cell_id) const {
  throw cms::Exception("FeatureNotImplemented") << "Neighbor search is not implemented in HGCalTriggerGeometryV9";
}

unsigned HGCalTriggerGeometryV9::getLinksInModule(const unsigned module_id) const {
...
unsigned HGCalTriggerGeometryV9::getModuleSize(const unsigned module_id) const {
  unsigned nWafers = 1;
  return nWafers;
}

unsigned HGCalTriggerGeometryV9::getNextSector(const unsigned sector) const {
...
unsigned HGCalTriggerGeometryV9::getPreviousSector(const unsigned sector) const {
...
// HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV9::getStage1LinksFromStage2Fpga(
...
unsigned HGCalTriggerGeometryV9::getStage1FpgaFromStage1Link(const unsigned link_id) const {
...
// unsigned HGCalTriggerGeometryV9::getStage2FpgaFromStage1Link(const unsigned link_id) const {
//   HGCalTriggerBackendDetId id(link_id);
...
std::vector<unsigned> HGCalTriggerGeometryV9::getLpgbtsFromStage1Fpga(const unsigned stage1_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV9::getModulesFromStage1Fpga(const unsigned stage1_id) const {
...
unsigned HGCalTriggerGeometryV9::getStage1FpgaFromLpgbt(const unsigned lpgbt_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV9::getModulesFromLpgbt(const unsigned lpgbt_id) const {
  geom_set modules;
  HGCalTriggerBackendDetId id(lpgbt_id);
...
HGCalTriggerGeometryV9::geom_set HGCalTriggerGeometryV9::getLpgbtsFromModule(const unsigned module_id) const {
  geom_set lpgbt_ids;
...
unsigned HGCalTriggerGeometryV9::getStage1FpgaFromModule(const unsigned module_id) const {
  HGCalTriggerModuleDetId id(module_id);
...
GlobalPoint HGCalTriggerGeometryV9::getTriggerCellPosition(const unsigned trigger_cell_det_id) const {
...
GlobalPoint HGCalTriggerGeometryV9::getModulePosition(const unsigned module_det_id) const {
...
// void HGCalTriggerGeometryV9::fillMaps() {
...
//           edm::LogError("HGCalTriggerGeometryV9") << "One module is connected to two separate Stage1 FPGAs";
//         }
//       }
//     }
...
unsigned HGCalTriggerGeometryV9::packLayerSubdetWaferId(unsigned layer, int subdet, int waferU, int waferV) const {
...
void HGCalTriggerGeometryV9::unpackLayerSubdetWaferId(
...
void HGCalTriggerGeometryV9::etaphiMappingFromSector0(int& ieta, int& iphi, unsigned sector) const {
  if (sector == 0) {
    return;
  }
  if (sector == 2) {
...
HGCalGeomRotation::WaferCentring HGCalTriggerGeometryV9::getWaferCentring(unsigned layer, int subdet) const {
...
unsigned HGCalTriggerGeometryV9::tcEtaphiMappingToSector0(int& tc_ieta, int& tc_iphi) const {
  unsigned sector = 0;
...
void HGCalTriggerGeometryV9::getScintillatoriEtaiPhi(
...
bool HGCalTriggerGeometryV9::validTriggerCell(const unsigned trigger_cell_id) const {
  return validTriggerCellFromCells(trigger_cell_id);
}

bool HGCalTriggerGeometryV9::disconnectedModule(const unsigned module_id) const {
...
unsigned HGCalTriggerGeometryV9::triggerLayer(const unsigned id) const {
...
bool HGCalTriggerGeometryV9::validCell(unsigned cell_id) const {
  bool is_valid = false;
  unsigned det = DetId(cell_id).det();
  switch (det) {
    case DetId::HGCalEE:
...
bool HGCalTriggerGeometryV9::validTriggerCellFromCells(const unsigned trigger_cell_id) const {
...
bool HGCalTriggerGeometryV9::validCellId(unsigned subdet, unsigned cell_id) const {
  bool is_valid = false;
  switch (subdet) {
    case DetId::HGCalEE:
      is_valid = eeTopology().valid(cell_id);
...
int HGCalTriggerGeometryV9::detIdWaferType(unsigned det, unsigned layer, short waferU, short waferV) const {
  int wafer_type = 0;
  switch (det) {
    case DetId::HGCalEE:
...
void HGCalTriggerGeometryV9::layerWithoutOffsetAndSubdetId(unsigned& layer, int& subdetId, bool isSilicon) const {
  if (!isSilicon) {
...
unsigned HGCalTriggerGeometryV9::layerWithOffset(unsigned id) const {
