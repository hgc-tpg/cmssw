...
class HGCalTriggerGeometryV19Imp1 : public HGCalTriggerGeometryBase {
public:
  HGCalTriggerGeometryV19Imp1(const edm::ParameterSet& conf);
...
private:
  ...
  unsigned hSc_sd_triggercell_size_ = 2;
  unsigned hSc_hd_triggercell_size_ = 3;
  static constexpr unsigned hSc_layer_transition_hd_ = 12;
...
HGCalTriggerGeometryV19Imp1::HGCalTriggerGeometryV19Imp1(const edm::ParameterSet& conf)
...
void HGCalTriggerGeometryV19Imp1::reset() {
...
void HGCalTriggerGeometryV19Imp1::initialize(const HGCalGeometry* hgc_ee_geometry,
...
unsigned HGCalTriggerGeometryV19Imp1::getTriggerCellFromCell(const unsigned cell_id) const {
  ...
  if (det == DetId::HGCalHSc) {
    ...
    unsigned type = 0;
    trigger_cell_id = HGCScintillatorDetId(type, layer, ieta, iphi);
  }
  // HFNose
...
unsigned HGCalTriggerGeometryV19Imp1::getModuleFromCell(const unsigned cell_id) const {
  return getModuleFromTriggerCell(getTriggerCellFromCell(cell_id));
}

unsigned HGCalTriggerGeometryV19Imp1::getModuleFromTriggerCell(const unsigned trigger_cell_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getCellsFromTriggerCell(
  ...
  if (det == DetId::HGCalHSc) {
    ...
    for (int ietaAbs = ieta0; ietaAbs < ieta0 + (int)tc_size; ietaAbs++) {
      ...
      for (int iphi = iphi0; iphi < iphi0 + (int)tc_size; iphi++) {
        HGCScintillatorDetId cell_id(type_sipm.first, layer, ieta, iphi);
        cell_id.setSiPM(type_sipm.second);
        cell_id.setGranularity(granularity);
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getCellsFromModule(const unsigned module_id) const {
  geom_set cell_det_ids;
...
HGCalTriggerGeometryBase::geom_ordered_set HGCalTriggerGeometryV19Imp1::getOrderedCellsFromModule(
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getTriggerCellsFromModule(
    const unsigned module_id) const {
...
HGCalTriggerGeometryBase::geom_ordered_set HGCalTriggerGeometryV19Imp1::getOrderedTriggerCellsFromModule(
    const unsigned module_id) const {
  HGCalTriggerModuleDetId hgc_module_id(module_id);
  unsigned subdet = hgc_module_id.triggerSubdetId();
...
unsigned HGCalTriggerGeometryV19Imp1::getModuleSize(const unsigned module_id) const {
  unsigned nWafers = 1;
  return nWafers;
}

unsigned HGCalTriggerGeometryV19Imp1::getNextSector(const unsigned sector) const {
...
unsigned HGCalTriggerGeometryV19Imp1::getPreviousSector(const unsigned sector) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getStage1FpgasFromStage2Fpga(
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getStage2FpgasFromStage1Fpga(
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getStage1LinksFromStage2Fpga(
    const unsigned stage2_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getStage1LinksFromStage1Fpga(
    const unsigned stage1_id) const {
  geom_set stage1link_ids;
...
std::vector<unsigned> HGCalTriggerGeometryV19Imp1::getLpgbtsFromStage1Fpga(const unsigned stage1_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getModulesFromStage1Fpga(
    const unsigned stage1_id) const {
...
HGCalTriggerGeometryBase::geom_set HGCalTriggerGeometryV19Imp1::getModulesFromLpgbt(const unsigned lpgbt_id) const {
  geom_set modules;
  HGCalTriggerBackendDetId id(lpgbt_id);
...
HGCalTriggerGeometryV19Imp1::geom_set HGCalTriggerGeometryV19Imp1::getLpgbtsFromModule(const unsigned module_id) const {
  geom_set lpgbt_ids;
...
GlobalPoint HGCalTriggerGeometryV19Imp1::getTriggerCellPosition(const unsigned trigger_cell_det_id) const {
...
GlobalPoint HGCalTriggerGeometryV19Imp1::getModulePosition(const unsigned module_det_id) const {
...
void HGCalTriggerGeometryV19Imp1::fillMaps() {
  ...
  try {
    ...
    edm::LogError("HGCalTriggerGeometryV19Imp1")
    ...
    for (unsigned lpgbt_id = 0; lpgbt_id < mapping_config.at("lpgbt").size(); lpgbt_id++) {
      ...
      for (auto& modules : mapping_config.at("lpgbt").at(lpgbt_id).at("Modules")) {
        ...
        if (result.second == false &&
          ...
          edm::LogError("HGCalTriggerGeometryV19Imp1") << "One module is connected to two separate Stage1 FPGAs";
        }
      }
    }
...
unsigned HGCalTriggerGeometryV19Imp1::packLayerSubdetWaferId(unsigned layer, int subdet, int waferU, int waferV) const {
...
void HGCalTriggerGeometryV19Imp1::unpackLayerSubdetWaferId(
...
void HGCalTriggerGeometryV19Imp1::etaphiMappingFromSector0(int& ieta, int& iphi, unsigned sector) const {
  iphi += hSc_num_panels_per_sector_ * sector;
}

HGCalGeomRotation::WaferCentring HGCalTriggerGeometryV19Imp1::getWaferCentring(unsigned layer, int subdet) const {
  if (subdet == HGCalTriggerSubdetector::HGCalEETrigger) {  // CE-E
    ...
    edm::LogError("HGCalTriggerGeometryV19") << "HGCalTriggerGeometryV19: trigger sub-detector expected to be silicon";
    return HGCalGeomRotation::WaferCentring::WaferCentred;
  }
}

unsigned HGCalTriggerGeometryV19Imp1::tcEtaphiMappingToSector0(int& tc_ieta, int& tc_iphi) const {
  unsigned sector = (tc_iphi - 1) / hSc_tcs_per_sector_;
  if (sector > nSectors_) {
    throw cms::Exception("HGCalTriggerGeometryV19Imp1::OutOfRange")
...
void HGCalTriggerGeometryV19Imp1::getScintillatoriEtaiPhi(
...
bool HGCalTriggerGeometryV19Imp1::validTriggerCell(const unsigned trigger_cell_id) const {
...
unsigned HGCalTriggerGeometryV19Imp1::triggerLayer(const unsigned id) const {
...
bool HGCalTriggerGeometryV19Imp1::validCell(unsigned cell_id) const {
  bool is_valid = false;
  unsigned det = DetId(cell_id).det();
  switch (det) {
    case DetId::HGCalEE:
...
bool HGCalTriggerGeometryV19Imp1::validTriggerCellFromCells(const unsigned trigger_cell_id) const {
...
bool HGCalTriggerGeometryV19Imp1::validCellId(unsigned subdet, unsigned cell_id) const {
  bool is_valid = false;
  switch (subdet) {
    case DetId::HGCalEE:
      is_valid = eeTopology().valid(cell_id);
...
int HGCalTriggerGeometryV19Imp1::detIdWaferType(unsigned det, unsigned layer, short waferU, short waferV) const {
  int wafer_type = 0;
  switch (det) {
    case DetId::HGCalEE:
...
bool HGCalTriggerGeometryV19Imp1::waferIsHD(unsigned det, unsigned layer, short waferU, short waferV) const {
  bool ishd = false;
  switch (det) {
    case DetId::HGCalEE:
...
void HGCalTriggerGeometryV19Imp1::layerWithoutOffsetAndSubdetId(unsigned& layer, int& subdetId, bool isSilicon) const {
  if (!isSilicon) {
...
unsigned HGCalTriggerGeometryV19Imp1::layerWithOffset(unsigned id) const {
...
DEFINE_EDM_PLUGIN(HGCalTriggerGeometryFactory, HGCalTriggerGeometryV19Imp1, "HGCalTriggerGeometryV19Imp1");
